...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   func_unsigned_ltoa_base.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: eluiz-to <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/30 10:40:19 by eluiz-to          #+#    #+#             */
/*   Updated: 2021/12/30 10:40:22 by eluiz-to         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	count_len(unsigned long n, char *base);
static char	*convert_int(unsigned long n, int n_len, char *str, char *base);
